...
oms_setReal("TrainCrossing.root.TrainLight.Intersection",100.0)
...
function crash()
  ...
  train = 0 
  for i=1,3 do 
      if oms_getReal("TrainCrossing.root.trainCollection.DistanceVec[".. i .."]")>=oms_getReal("TrainCrossing.root.Sensors.Intersection") and oms_getReal("TrainCrossing.root.trainCollection.DistanceVec[".. i .."]")-oms_getReal("TrainCrossing.root.trainCollection.LengthVec[".. i .."]")<oms_getReal("TrainCrossing.root.Sensors.Intersection")
      then 
          trainDanger=true
          train=i 
      end 
  ...
  for i=1,3 do
      if oms_getReal("TrainCrossing.root.carCollection.DistanceVec[".. i .."]")>=oms_getReal("TrainCrossing.root.TrainLight.Intersection") and  oms_getReal("TrainCrossing.root.carCollection.DistanceVec[".. i .."]")-oms_getReal("TrainCrossing.root.carCollection.LengthVec[".. i .."]")<oms_getReal("TrainCrossing.root.TrainLight.Intersection")
      then 
          carDanger=true 
          car=i 
      end 
